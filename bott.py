...
def web_scraping(qs):
    ...
    if len(div0)!=0:
       ...
       for para in paragraphs:
        ...
        answer = "Sorry, the desired results not found"
...
def wishme():
    ...
    if 0 <= hour < 12:
        text = "Good Morning, I am Tally. How can I Serve you?"
    elif 12 <= hour < 18:
        text = "Good Afternoon, I am Tally. How can I Serve you?"
    else:
        text = "Good Evening, I am Tally. How can I Serve you?"
...
if __name__ == "__main__":
    ...
    root=Tk()
    root.title("Jane Video Chat Bot")
    root.geometry('8334x8334+-5+0')
    root.configure(background='white')

    img1= PhotoImage(file='img1.jpeg')
    img2= PhotoImage(file='button.jpeg')
    img3= PhotoImage(file='icon.png')
    img4= PhotoImage(file='terminal.png')
    background_image=PhotoImage(file="background.jpeg")
    front_image = PhotoImage(file="front.jpeg")
    ...
    frames = [PhotoImage(file='gif.png',format = 'gif -index %i' %(i)) for i in range(20)]
